  ...
  return (
    ...
    <div className="home-container">
        ...
        <div className="option-holder">
            <div className={`options ${frame==1?"option-clicked":""}`} onClick={()=>{
                setframe("1")
            }}>Live Requests</div>
            <div className={`options ${frame==2?"option-clicked":""}`} onClick={()=>{
                setframe("2")
            }}>Data Bank</div>
            <div className={`options ${frame==3?"option-clicked":""}`}onClick={()=>{
                setframe("3")
            }}>Campus Buzz</div>
            <div className={`options ${frame==4?"option-clicked":""}`}onClick={()=>{
                setframe("4")
            }}>Updates</div>
        </div>
        ...
        {frame=="4"?<><div className='options'><Updates/></div></>:""}
